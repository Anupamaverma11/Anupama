...
const songs = [
    ...
    {
        id: 4,
        songName: 'Mortals<br> <div class="subtitle">Warriyo</div>',

        poster: "img/4.jpg"
    },
    {
        id: 5,
        songName: 'Ertugrul Ghazi Music<br> <div class="subtitle">Nasheed</div>',

        poster: "img/5.jpg"
    },
    {
        id: 6,
        songName: 'My Heart<br> <div class="subtitle">William McDowell</div>',
    ...
    {
        id: 11,
        songName: 'Lagdi Lahor Di<br> <div class="subtitle">Guru Randhawa</div>',

        poster: "img/11.jpg"
    },
    {
        id: 12,
        songName: 'Putt Jatt Da<br> <div class="subtitle">Diljit Doshanjh</div>',
    ...
    {
        id: 20,
        songName: 'Vande Mataram<br> <div class="subtitle">Bankim Chandra Chaterjee</div>',
...
const makeAllPlays = () => {
    Array.from(document.getElementsByClassName('playlistPlay')).forEach((el) => {
        el.style.plays = 'rgb(105, 105, 105, .0)';
